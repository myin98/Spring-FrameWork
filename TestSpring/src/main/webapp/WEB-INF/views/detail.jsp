...
<body>
	<%
	String txt = request.getAttribute("title").toString();
	String txt2 = request.getAttribute("content").toString();
	%>
    ...
    <div class="container mt-3">
        ...
        <form action="detail" method="get">
            <div class="mb-3 mt-3">
              ...
              <input type="text" class="form-control" id="title" placeholder="Enter title" name="title" value="<%=txt %>" required autocomplete="off">
            </div>
            <div class="mb-3">
              <label for="content" class="form-label">Content:</label>
              <input type="text" class="form-control" id="content" placeholder="Enter content" name="content" value="<%=txt2 %>" autocomplete="off">
            </div>
